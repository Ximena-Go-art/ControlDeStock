...
namespace ControlDeStock.Services
{
    public class MovimientoService
    {
        ...
        public async Task<bool> DeleteAsync(string _id)
        {
            ...
            string url = $"https://basededatosprueba-43f2.restdb.io/rest/movimiento/{_id}apikey=0eb02941b4157bb3f6f863477b58795b87db6?";
        ...
        {   // Método para crear un nuevo producto
            ...
            using (HttpClient client = new HttpClient())
            {
                ...
                else
                {
                    ...
                    throw new Exception($"Error al registrar el movimiento. Respuesta API: {errorDetalle}");
                }
            }
        }
